...
def slv(L,R,B):
    ...
    for i in range(0,len(L)):
        ...
        for j in range(0,len(R)):
            ...
            if dis<r1+r2:
                sl=sl+((s1*v2+s2*v1)*exp(-pow(dis,2)/(2*pow(sikma,2))))/10
    return sl
            ...
            for j in range(0,len(R)):
                ...
                if int(h2)==0:
                    ...
                    if dis<=r1+r2:
                        ep=sqrt(e1*e2)
                        sigma=(r1+r2)/2
                        A=0.4*ep*pow(sigma,12)
                        B=0.4*ep*pow(sigma,6)
                        vw=vw+(A/(pow(dis,12)+2.220446049250313e-16)-B/(pow(dis,6)+2.220446049250313e-16))
    return vw
    ...
    for i in range(0,len(L)):
        ...
        for j in range(0,len(R)):
            ...
            if dis<=r1+r2:
                ...
                d=A+B/d
                qj=float(R[j][7])
                elec=elec+(qi*qj/(dis*d+2.220446049250313e-16))*100
    return elec
        ...
        for j in range(0,len(R)):
            ...
            if (h1>0)|(h2>0):
                ...
                if dis<=r1+r2+1:
                    ...
                    if teta>90:
                        chb=chb-0.05
                        hb=hb+(A/pow(dis,12)-B/pow(dis,10)*teta)/20
    return chb+hb
